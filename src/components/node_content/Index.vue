    ...
    <div class="p-fluid">
      <div class="p-field p-grid">
        ...
        <div :class="`${$style.list}`">
          ...
          <br><br>1. Collect the <b>best explanations</b> of the fundamentally important knowledge. It should be possible to track correctness of these explanations down to fundamental theories/experiments using <b>"based on"</b> feature of SciMap (see video below).
