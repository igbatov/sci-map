...
export default {
  ...
  setup(props: {nodeId: string, resources: Record<string, Resource>, resourcesRating: ResourceRating[]}) {
    const store = useStore();

    return {
      changeRating: ( resourceID: string, e: { originalEvent: Event, value: string } ) => {
        const rr = {
          nodeID: props.nodeId,
