<template>
  ...
  >
    ...
    <div style="width:40em;">
      ...
      <b>"based on"</b> feature of SciMap (see video below). <br /><br />2. Help
      to <b>discover and join communities</b> that use this knowledge to solve
      hard problems of humanity. <br /><br />When everyone in tech goes crazy on
      AI and blockchain it seems that we should invest more in platform that can
      help to navigate in exponential abundance of information generated by AI
      and to find new meaningful jobs in a new reality. SciMap should be a
      breath of fresh air and <b>guiding star</b> in the chaos of rapidly
      ...
      notation to write formulas. <br />- To add "based on" links between nodes,
      press plus button. <br />- To add video just insert link from youtube in a
      form
      <div
      ...
      - To add add image click on header image, then "upload" and copy URL to
