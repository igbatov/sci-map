...
export const store = {
  ...
  actions: {
    ...
    [actions.AddPin](
      { commit, rootState }: { commit: Commit, rootState: {tree: {nodeRecord: Record<number, NodeRecordItem>}}},
      ...
      for (const parentId of parentIds) {
        commit(mutations.ADD_TO_PINS_REVERSE, {nodeId: parentId, pinId: v.nodeId})
      }
    },
    [actions.RemovePin](
